<template>
  <div id='myMap'>
    <baidu-map class="map" :scroll-wheel-zoom="true" center="中国" :mapStyle="mapStyle" :zoom="5" >
      <bml-heatmap :data="cityData" :max="100" :radius="20">
      </bml-heatmap>
    </baidu-map>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    //         strokeWeight: 1, fillColor: "#091934", fillOpacity: 1
    //       }); //建立多边形覆盖物
